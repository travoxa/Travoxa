...
const StoryDetailPage = () => {
    ...
    const handleLike = async () => {
        if (!session) return alert("Please login to like stories");
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/stories/${id}/like`, {
                method: 'POST',
    ...
    if (!story) return (
        <div className="min-h-screen bg-white flex flex-col items-center justify-center">
            ...
            <button onClick={() => route('/travoxa-discovery/stories')} className="text-emerald-600 font-bold">Back to Feed</button>
        </div>
    );
        ...
        <div className="bg-[#fcfdfd] min-h-screen font-sans">
                    ...
                    <div className="max-w-[1400px] mx-auto">
                        <div className="flex flex-wrap items-center gap-3 mb-6">
                            ...
                            <div className="flex items-center gap-2 text-white/80 text-sm font-medium">
                                <FiClock size={16} /> {story.duration || 'Flexible'}
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="text-white">
                                    <p className="text-sm font-bold Mont tracking-wide">Story by {story.author?.name}</p>
                                    <p className="text-xs text-white/60 Inter">{new Date(story.createdAt).toLocaleDateString()}</p>
                                </div>
                            </div>
            ...
            <section className="max-w-4xl mx-auto px-6 py-20">
                <div className="text-center mb-16" data-aos="fade-up">
                    <h2 className="text-2xl font-bold text-slate-900 Mont mb-6">Story Overview</h2>
                    ...
                    <div className="mb-20" data-aos="fade-up">
                        <div className="bg-gradient-to-br from-pink-50 to-purple-50 p-8 rounded-[2rem] border border-pink-100 flex flex-col items-center gap-6">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-slate-500 text-sm mb-6">This story has a standalone reel shared by the author.</p>
                                <a 
                                    href={story.igLink} 
                                    target="_blank" 
            ...
            <section className="max-w-[1400px] mx-auto px-6 pb-40">
                <div className="text-center mb-12">
                     <h2 className="text-xs font-bold text-emerald-600 tracking-[0.3em] uppercase mb-4">Story Timeline</h2>
                     <div className="w-12 h-1 bg-emerald-600 mx-auto" />
                </div>
                <Timeline steps={story.steps} />
                ...
                <div className="text-center mt-20" data-aos="zoom-in">
                    ...
                    <p className="text-slate-500 Inter mb-10 max-w-lg mx-auto">
                        "{story.author?.name} finished this journey with memories for a lifetime. Start yours today."
                    </p>
                    <button 
                         onClick={() => route('/tour')}

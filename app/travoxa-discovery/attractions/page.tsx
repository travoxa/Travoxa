...
import { attractionsPackages, AttractionPackage } from '@/data/attractionsData';
import AOS from 'aos';
...
const AttractionsPage = () => {
    ...
    // State
    const [filteredPackages, setFilteredPackages] = useState<AttractionPackage[]>(attractionsPackages);
    // Search State
    ...
    const applyFilters = (query: typeof searchQuery, currentFilters: typeof filters) => {
        let results = attractionsPackages;

            ...
            {deletingId && (
                <div className="fixed inset-0 bg-white/60 z-[100] flex items-center justify-center backdrop-blur-sm">
                    <div className="bg-white rounded-3xl p-8 flex flex-col items-center gap-4 shadow-2xl border border-gray-100 animate-in fade-in zoom-in duration-300">
                        <Spinner size="md" text="Deleting sightseeing package..." />
                    </div>
                </div>
            )}
                ...
                <>
                    ...
                    {showListings && (loadingSightseeing ? (
                        <div className="w-full">
                            <h2 className="text-sm md:text-lg font-medium text-gray-800 mb-6 px-1">Existing Sightseeing Packages</h2>
                                    ...
                                    {([...sightseeing].sort((a, b) => {
                                        ...
                                        >
                                            <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 md:gap-4">
                                                <div>
                                                    <p className="text-[10px] font-semibold text-gray-500 uppercase md:hidden mb-0.5">Package Name</p>
                        ...
                        <div className="py-8 text-left px-1 text-gray-500 text-sm">No sightseeing packages found.</div>
                    ))}
                </>
            ) : (
                        ...
                        <div className="pt-8 border-t border-gray-200 mt-8 mb-8">
                            ...
                            {loadingRelated ? (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                                    ...
                                    {renderRelatedCheckboxes('Sightseeing', sightseeing, 'relatedSightseeing')}

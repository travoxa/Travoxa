    ...
    return (
        <div className="relative mx-[12px] mt-[12px] rounded-[12px] py-16 md:py-24 overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center px-4">
                ...
                <h1 className="mt-4 text-3xl md:text-5xl lg:text-6xl font-light text-slate-900 mb-8 Mont tracking-tight text-center drop-shadow-sm">
                    Curated Tours for the <br /> <span className="text-emerald-600 font-serif italic font-medium">Modern Explorer</span>
                </h1>

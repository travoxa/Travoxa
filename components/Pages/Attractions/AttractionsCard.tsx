                ...
                <div className="relative h-56 overflow-hidden">
                    ...
                    <div className="absolute top-3 right-3 flex flex-col items-end gap-2">
                        <div className="bg-white/95 backdrop-blur-sm px-2 py-1 rounded-full flex items-center gap-1 shadow-sm border border-slate-100">
                            ...
                            <span className="text-[10px] font-black text-slate-900">{pkg.googleRating || pkg.rating || '4.5'}</span>
                        </div>
                        {pkg.badges && pkg.badges.length > 0 && (
                            <div className="bg-pink-600 text-white px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest shadow-lg shadow-pink-500/20 ring-1 ring-white/20">
                                {pkg.badges[0]}
                            </div>
                        )}
                    </div>
                        ...
                        <div>
                            {pkg.entryFee > 0 ? (
                                <>
                                    ...
                                    <span className="text-lg font-bold text-slate-900 Mont">₹{pkg.entryFee}</span>
                                </>
                            ) : (

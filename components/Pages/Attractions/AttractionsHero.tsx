        ...
        <div className="relative mx-[12px] mt-[12px] rounded-[12px] py-16 md:py-24">
            ...
            <div className="flex flex-col items-center justify-center px-4">
                <h1 className="mt-24 text-3xl md:text-5xl lg:text-6xl font-light text-slate-900 mb-8 Mont tracking-tight text-center">
                    Discover Iconic <br /> <span className="text-pink-500 font-serif italic">Attractions & Monuments</span>
                </h1>

                {/* Search Bar */}
                <div className="w-full max-w-4xl bg-white rounded-full p-2.5 flex flex-col md:flex-row gap-1 items-center border border-slate-200 hover:border-pink-500/30 transition-colors">

                    {/* State Dropdown */}
                    <div className="flex-1 w-full relative group">
                        <div className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-300 group-hover:text-pink-500 transition-colors">
                    ...
                    <button
                        ...
                        className="w-full md:w-auto h-9 px-6 bg-slate-900 hover:bg-pink-600 text-white text-[10px] font-medium rounded-full transition-all flex items-center justify-center gap-2 active:scale-95 uppercase tracking-wide ml-1"
                    >
                        <FaSearch size={8} />
                        Search
                    </button>

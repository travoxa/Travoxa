...
export default function Hero() {
  return (
    <div className="w-screen flex justify-center items-center px-[12px] py-[12px]" >
      <div className="w-full h-[97vh] bg-center bg-cover bg-no-repeat rounded-[12px]" style={{ backgroundImage: `url(/hero-bg.jpg)` }} >
          <p className="text-center pt-[10vh] text-[200px] font-bold text-white Mont tracking-wider text-shadow-blue-400" >TRAVOXA</p>

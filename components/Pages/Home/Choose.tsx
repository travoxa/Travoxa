...
const Choose = () => {
  return (
    <div className="mx-[12px] mt-[24px] bg-white py-[48px] px-[48px] rounded-[12px] relative z-10">
      <div className="text-center lg:text-left block justify-between lg:justify-center items-center lg:items-start gap-[24px]">
        ...
        <div className="lg:mr-[48px] text-center">
          ...
          <p className="text-[20px] text-[#4da528] font-light Mont">
            ...
            <span className="lg:block hidden">
              ...
              You travel with confidence—always.
            </span>
          </p>
        </div>

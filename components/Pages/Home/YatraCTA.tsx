...
const YatraCTA = () => {
    return (
      ...
      <style>{`
        ...
        .yt-wrap{position:relative;width:400px;border-radius:26px;background:linear-gradient(145deg,rgba(220,255,235,.65),rgba(180,245,215,.5),rgb(68, 238, 170));backdrop-filter:blur(24px);border:1.5px solid rgba(255,255,255,.7);box-shadow:0 0px 34px rgb(196, 250, 220),inset 0 1px 0 rgba(255,255,255,.8);padding:0 24px 20px;overflow:hidden;animation:yt-in .7s both}
        ...
        .yt-scene{position:relative;height:180px}
        .yt-stage{position:absolute;top:10%;left:50%;transform:translateX(-50%);width:260px;height:155px}
        .yt-pack{position:absolute;bottom:0;left:50%;transform:translateX(-50%);width:70px;height:82px;z-index:4}
        .yt-pack-body{position:absolute;bottom:0;left:0;width:70px;height:72px;background:linear-gradient(160deg,#4caf50 0%,#2e7d32 100%);border-radius:14px 14px 10px 10px;box-shadow:4px 6px 16px rgba(30,100,30,.45),inset 0 2px 4px rgba(255,255,255,.2)}
        .yt-pack-top{position:absolute;top:0;left:8px;width:54px;height:18px;background:linear-gradient(135deg,#66bb6a,#388e3c);border-radius:8px 8px 0 0;box-shadow:inset 0 2px 3px rgba(255,255,255,.2)}
        .yt-pack-roll{position:absolute;top:-16px;left:10px;width:50px;height:20px;background:linear-gradient(135deg,#81c784,#43a047);border-radius:10px;box-shadow:0 2px 6px rgba(30,100,30,.35)}
        ...
        .yt-tent{position:absolute;bottom:0;right:4px;width:72px;height:58px;z-index:3}
        .yt-tent-sh{position:absolute;bottom:0;left:4px;width:0;height:0;border-left:32px solid transparent;border-right:32px solid transparent;border-bottom:48px solid #f57f17;clip-path:polygon(50% 0%,100% 100%,0% 100%)}
        .yt-tent-bd{position:absolute;bottom:0;left:0;width:0;height:0;border-left:36px solid transparent;border-right:36px solid transparent;border-bottom:54px solid #f9a825;filter:drop-shadow(3px 4px 8px rgba(249,168,37,.4))}
        .yt-tent-dr{position:absolute;bottom:0;left:50%;transform:translateX(-50%);width:18px;height:22px;background:linear-gradient(180deg,#e65100,#bf360c);border-radius:9px 9px 0 0}
        .yt-tent-pl{position:absolute;bottom:0;left:50%;transform:translateX(-50%);width:2px;height:60px;background:linear-gradient(180deg,#8d6e63,#5d4037);border-radius:1px}
        ...
        .yt-title{font-family:'Barlow Condensed',sans-serif;font-size:26px;font-weight:800;letter-spacing:2px;color:#1a3a2a;text-transform:uppercase;margin-bottom:8px}
      ...
      <div className="yt-wrap">
        ...
        <div style={{textAlign:"center"}}>
          ...
          <a href="#" className="yt-btn">Explore Opportunities →</a>
        </div>
      </div>
    </div>
        </div>

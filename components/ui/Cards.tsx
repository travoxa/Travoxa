...
export default function Card({ name, description, image, index }: CardProps) {
  ...
  return (
        <div
            className={`
                group relative z-1 w-[50vw] lg:w-[30vw] h-[20vh] lg:h-[50vh] shrink-0 rounded-xl overflow-hidden shadow-lg
                mx-4 p-4
            ...
            {/* Card content */}
            <div className="absolute z-1 bottom-2 lg:bottom-5 left-2 lg:left-5 opacity-100 group-hover:opacity-0 transition-opacity duration-300">

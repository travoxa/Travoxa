    ...
    return (
        <>
            ...
            <div className="relative max-w-4xl mx-auto text-center space-y-8 text-white">
                ...
                <button className="Inter bg-white hover:bg-white-400 px-10 py-4 rounded-full text-black border-2 border-black text-lg font-medium transition duration-300 shadow-lg hover:scale-105">
